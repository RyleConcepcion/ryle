...
public class MainDashboardController implements Initializable {
    ...
    public void btnHomeOnClick(ActionEvent actionEvent) {
        ...
        Controllers.HomeController homeController = fxmlLoader.getController();
    ...
    public void btnOrdersOnClick(ActionEvent actionEvent) {
        ...
        Controllers.OrdersController orders = fxmlLoader.getController();
        orders.listOrders();
    }
    ...
    public void btnCustomersOnClick(ActionEvent actionEvent) {
        ...
        Controllers.CustomersController controller = fxmlLoader.getController();
