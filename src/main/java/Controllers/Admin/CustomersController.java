...
public class CustomersController {
    ...
    private void btnEditCustomer(int customer_id) {
        ...
        try {
            fxmlLoader.load(getClass().getResource("/Fxml/Admin/editCustomer.fxml").openStream());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void btnViewCustomer(int customer_id) {
        FXMLLoader fxmlLoader = new FXMLLoader();
        try {
            fxmlLoader.load(getClass().getResource("Fxml/Admin/viewCustomer.fxml").openStream());
        } catch (IOException e) {
            e.printStackTrace();
        }
