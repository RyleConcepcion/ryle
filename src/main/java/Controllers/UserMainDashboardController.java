...
public class UserMainDashboardController implements Initializable {
    ...
    public void btnHomeOnClick(ActionEvent actionEvent) {
        ...
        Controllers.UserHomeController homeController = fxmlLoader.getController();
    ...
    public void btnOrdersOnClick(ActionEvent actionEvent) {
        ...
        Controllers.UserOrdersController ordersController = fxmlLoader.getController();
    ...
    public void btnProductsOnClick(ActionEvent actionEvent) {
        ...
        Controllers.UserProductsController userController = fxmlLoader.getController();
    ...
    public void btnLogOutOnClick(ActionEvent actionEvent) throws IOException {
        ...
        if (result.get() == ButtonType.OK){
            Controllers.UserSessionController.cleanUserSession();
            Stage dialogStage;
            new Stage();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        lblUsrName.setText(Controllers.UserSessionController.getUserFullName());
